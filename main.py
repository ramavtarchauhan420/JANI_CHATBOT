...
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","ll_THUNDER_lll")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","CRAZY_OP_02")
...
SOURCE = 'https://github.com/ramavtarchauhan420/JANI_CHATBOT'
x=["❤️","🎉","✨","🪸","🎉","🎈","🎯"]
g=choice(x)
...
print(f"{BOT_NAME} ɪs ᴀʟɪᴠᴇ! ʙᴏᴛ ʙʏ ɪsᴛᴋʜᴀʀ")      
Mukesh.run()
